...
@php
    // $allUser=App\Models\User::where('ban_status',0)->orderBy('id','desc')->get();
    // $allUser=App\Models\Banner::where('ban_status',0)->orderBy('ban_id','desc')->get();
@endphp
                                    ...
                                    <td>
                                        <div class="btn-group btn_group_manage" role="group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item"href="#" id="restore" data-bs-toggle="modal" data-bs-target="#restoreModal" data-id="{{$data->ban_id}}">Restore</a></li>
                                                <li><a class="dropdown-item" href="#" id="delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="{{$data->ban_id}}">Delete</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
            ...
            <form method="post" action="{{url('dashboard/banner/restore')}}">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body modal_body">
                        ...
                        Are you sure want to restore this data item?
                    </div>
